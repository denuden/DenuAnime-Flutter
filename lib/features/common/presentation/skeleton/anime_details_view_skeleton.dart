...
class AnimeDetailsViewSkeleton extends StatelessWidget {
  final bool isLoading;
  final AnimeDetailsModel animeDetails = animeDetailsSample;
  ...
  AnimeDetailsViewSkeleton({super.key, required this.isLoading});
